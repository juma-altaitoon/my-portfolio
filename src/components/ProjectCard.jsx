...
export default function ProjectCard({ project }) {
    ...
    return (
        ...
        <div className="bg-blue-700 p-2 rounded-lg shadow-inner flex flex-col h-auto z-50 hover:shadow-white overflow-y">
            <Link to={`/projects/${project.slug}`} >
                ...
                <p className="text-gray-100 text-sm text-left flex-grow mx-1 mb-2">{project.description}</p>
                {/* Tech Stack Section */}
                <div className="mb-1">
