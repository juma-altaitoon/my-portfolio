...
export default function Sidebar() {
    ...
    return (
        <aside className="hidden md:block h-140 w-60 bg-gradient-to-br from-blue-700 to-black text-white p-3 rounded-4xl shadow-lg shadow-blue-500 mr-10 space-y-4 sticky overflow-hidden">
            <img src={"Portfolio_avatar.png"} alt={`${profile.firstName}'s Avatar`} loading='lazy' className='rounded-full w-32 h-32 my-4 mx-auto' />
            ...
            <div className='flex flex-wrap justify-start space-y-4 space-x-6 my-10'>
                {profile.linkedinUrl && (
